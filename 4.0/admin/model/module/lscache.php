...
namespace Opencart\Admin\Model\Extension\Litespeed\Module;

class Lscache extends \Opencart\System\Engine\Model {
	...
	public function  installLSCache() {
        ...
        $this->db->query(" insert into " . DB_PREFIX . "setting (store_id, code, `key`, value, serialized) values ('0', 'module_lscache', 'esi_common_cart', '{\"name\":\"cart\",\"route\":\"common\\/cart|info\",\"esi_type\":\"2\",\"esi_ttl\":\"1800\",\"esi_tag\":\"esi_cart\", \"default\":\"1\"}', '1')") ;
