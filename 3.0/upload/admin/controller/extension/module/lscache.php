...
class ControllerExtensionModuleLSCache extends Controller {
	...
	public function install() {
        ...
        $this->model_setting_event->addEvent('lscache_product_delete', 'admin/model/catalog/product/deleteProduct/after', 'extension/module/lscache/editProduct');

        $this->model_setting_event->addEvent('lscache_category_list', 'catalog/model/catalog/category/getCategories/after', 'extension/module/lscache/getCategories');
        $this->model_setting_event->addEvent('lscache_category_get', 'catalog/model/catalog/category/getCategory/after', 'extension/module/lscache/getCategory');
        $this->model_setting_event->addEvent('lscache_category_add', 'admin/model/catalog/category/addCategory/after', 'extension/module/lscache/addCategory');
        $this->model_setting_event->addEvent('lscache_category_edit', 'admin/model/catalog/category/editCategory/after', 'extension/module/lscache/editCategory');
        $this->model_setting_event->addEvent('lscache_category_delete', 'admin/model/catalog/category/deleteCategory/after', 'extension/module/lscache/editCategory');
        
        $this->model_setting_event->addEvent('lscache_manufacturer_list', 'catalog/model/catalog/manufacturer/getManufacturers/after', 'extension/module/lscache/getManufacturers');
        $this->model_setting_event->addEvent('lscache_manufacturer_get', 'catalog/model/catalog/manufacturer/getManufacturer/after', 'extension/module/lscache/getManufacturer');
        $this->model_setting_event->addEvent('lscache_manufacturer_add', 'admin/model/catalog/manufacturer/addManufacturer/after', 'extension/module/lscache/addManufacturer');
        $this->model_setting_event->addEvent('lscache_manufacturer_edit', 'admin/model/catalog/manufacturer/editManufacturer/after', 'extension/module/lscache/editManufacturer');
        $this->model_setting_event->addEvent('lscache_manufacturer_delete', 'admin/model/catalog/manufacturer/deleteManufacturer/after', 'extension/module/lscache/editManufacturer');
        
        $this->model_setting_event->addEvent('lscache_information_list', 'catalog/model/catalog/information/getInformations/after', 'extension/module/lscache/getInformations');
        $this->model_setting_event->addEvent('lscache_information_get', 'catalog/model/catalog/information/getInformation/after', 'extension/module/lscache/getInformation');
        $this->model_setting_event->addEvent('lscache_information_add', 'admin/model/catalog/information/addInformation/after', 'extension/module/lscache/addInformation');
        ...
        $this->model_setting_event->addEvent('lscache_add_ajax', 'catalog/controller/common/header/after', 'extension/module/lscache/addAjax');
        ...
        $this->model_setting_event->addEvent('lscache_user_forgotten', 'catalog/controller/account/forgotten/validate/after', 'extension/module/lscache/onUserAfterLogin');
