...
class ModelExtensionModuleLSCache extends Model {
	...
	public function  installLSCache() {
        ...
        $this->db->query(" insert into " . DB_PREFIX . "setting (store_id, code, `key`, value, serialized) values ('0', 'module_lscache', 'page_journal3_product_manufacturer', '{\"name\":\"Journal3 Brands\",\"route\":\"product\\/manufacturer\\/info\",\"cacheLogout\":\"1\",\"cacheLogin\":\"1\", \"default\":\"1\"}', '1')" ) ;
